...
<?php
  ...
  ?>
  <?php
   foreach($node->field_attachments as $files){
      print $files['view'];
     }
...
<br />Enter your comments, thoughts, ideas and questions, for other students to see, or the moderator to respond to.<br />
    <?php if ($links): ?>
